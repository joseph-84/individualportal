...
export const PAGES: PageDef[] = [
  ...
  { key: "checklists", label: "체크리스트", icon: "checklist" },
...
export const TITLES: Record<string, [string, string]> = {
  ...
  checklists: ["체크리스트", "체크박스 문서 관리"],
  files: ["파일 브라우저", "동기화된 서버 폴더"],
  favorites: ["즐겨찾기", "자주 찾는 문서·URL 모음"],
...
export const ICONS: Record<string, string> = {
  ...
  checklist: "M3 4h3v3h-3z M3.7 5.5l0.8 0.8L6 4.7 M9 5.5h8 M3 9h3v3h-3z M3.7 10.5l0.8 0.8L6 9.7 M9 10.5h8 M3 14h3v3h-3z M9 15.5h5",
  file: "M2.5 5.5A1.5 1.5 0 014 4h3l1.6 2H16a1.5 1.5 0 011.5 1.5v7A1.5 1.5 0 0116 16H4a1.5 1.5 0 01-1.5-1.5z",
  star: "M10 2.7l2.2 4.6 5 .7-3.6 3.6.9 5-4.5-2.4-4.5 2.4.9-5-3.6-3.6 5-.7z",
